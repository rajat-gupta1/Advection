...
int main(int argc, char *argv[])
{
    ...
    // double mCn[new_N + order * 2][new_N + order * 2];
    // double mCn1[new_N + order * 2][new_N + order * 2];
    ...
    for (int n = 0; n < NT; n++)
    {
        ...
        // for (int i = 0 + order; i < new_N + order; i++)
        //     for (int j = 0 + order; j < new_N + order; j++)
        //         mCn[i][j] = mCn1[i][j];
        temp = mCn1;
        mCn1 = mCn;
        mCn = temp;
